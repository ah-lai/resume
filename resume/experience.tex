...
\begin{siderules}
  ...
  \begin{cventries}
    ...
    {
      \begin{cvitems}
        \item{Designed and developed an analytics framework using \textbf{jQuery} and Segment API; analyzing user behavior for product $\>$ $\>$ $\>$ $\>$ $\>$$\>$$\>$$\>$  improvement by capturing \textbf{20} unique events across \textbf{300+} daily users}
        ...
        \item {Created support tools feature in \textbf{ASP.NET} application to search and clone studies; decreasing support resolve times by \textbf{20\%} }
      \end{cvitems}
    }
    \cventry
