  ...
  \begin{cventries}
    ...
    {Waterloo, Ontario}
    {
      \begin{cvitems}
        ...
        \item {Developed a microservice using \textbf{React} and \textbf{NodeJS} to upload and store study videos into \textbf{AWS S3}, increasing upload file size from 5GB to \textbf{5TB} and improving upload performance }
        \item {Built a support tool feature in an \textbf{ASP.NET} application to search and clone studies, improving support resolve times by \textbf{20\%} }
      \end{cvitems}
    }
    \cventry
    ...
    \cventry
      ...
      {Lumentum\hspace{0.15em} \bodyfontlight\itshape{- Hermetics Automation}}
      {May 2019 - Aug. 2019}
      {Ottawa, Ontario}
      {
        \begin{cvitems}
