  ...
  \begin{cventries}
    ...
    {W}
    {
      \begin{cvitems}
        ...
        \item {Implemented new factory method for AWS SDK in a legacy application (\textbf{ASP.NET}), applied \textbf{LoD} using \textbf{AWS Parameter} and \textbf{IAM Roles}, which significantly improved scalability and eliminated security vulnerabilities}
