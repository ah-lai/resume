  ...
  \begin{cventries}
    ...
    {W}
    {
      \begin{cvitems}
        ...
        \item {Analytics solution is loosely-coupled, isolated, and reusable, allowing it be implemented into 3 other company products}
    ...
    {W}
    {
      \begin{cvitems}
        ...
        \item {Implemented new factory method for AWS SDK in legacy application (\textbf{ASP.NET}), applied \textbf{LoD} using \textbf{AWS Parameter} and \textbf{IAM Roles}, which significantly improved scalability and eliminated security vulnerabilities}
