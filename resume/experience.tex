...
\begin{siderules}
  ...
  \begin{cventries}
    ...
    {
      \begin{cvitems}
        \item{Designed and developed an analytics library using \textbf{jQuery} and Segment API, analyzing user behavior for product improvements by capturing \textbf{20} unique events across \textbf{500+} daily users}
        ...
        \item {Designed and implemented a customer support tool using \textbf{C#} and \textbf{ASP.NET}, performing \textbf{mySQL} operations and improving support result times by \textbf{40\%} }
      \end{cvitems}
    }
    \cventry
